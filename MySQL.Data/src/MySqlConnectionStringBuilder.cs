    ...
    public sealed class MySqlConnectionStringBuilder : DbConnectionStringBuilder
    {
        ...
        static MySqlConnectionStringBuilder()
        {
          ...
          msb.SetValue("sharedmemoryname", value);
            ...
            Options.Add(new MySqlConnectionStringOption("cacertificatefile", "ca certificate file", typeof(string), null, false));
        ...
        /// <summary>
        /// This option specifies the path to a CA certificate file in a PEM Encoded (.pem) format.
        /// This should be used in with SslMode=VerifyCA or SslMode=VerifyFull to enable verification of a CA certificate that is not trusted by the Operating System's certificate store.
        /// </summary>
        [Category("Authentication")]
        [DisplayName("CA Certificate File")]
        [Description("CA certificate file in a PEM Encoded (.pem) format")]
        public string CACertificateFile
        {
            get { return (string)values["cacertificatefile"]; }
            set { SetValue("cacertificatefile", value); }
        }
